  ...
  const products = [
    {
      ...
      glow: "linear-gradient(135deg, #fde68a 0%, #fdba74 50%, #fff7ed 100%)",
    },
    {
      ...
      glow: "linear-gradient(135deg, #fed7aa 0%, #fdba74 50%, #fff7ed 100%)",
    },
    {
      name: "Cocoa Nut Mix",
      ...
      glow: "linear-gradient(135deg, #fef3c7 0%, #fdba74 50%, #fde68a 100%)",
    },
  ];
      ...
      <main>
        <section className="relative mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-24">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/60 bg-[linear-gradient(135deg,#fff8ef_0%,#fff1de_45%,#ffe6c9_100%)] p-8 shadow-[0_20px_80px_rgba(164,112,42,0.18)] lg:p-12">
            ...
            <div className="absolute left-6 top-8 hidden rounded-full border border-white/70 bg-white/70 px-4 py-2 text-sm font-bold text-amber-600 shadow-lg md:block">
              ✨ Fresh • Cheerful • Giftable
            </div>
            <div className="absolute right-8 top-10 hidden rounded-full border border-white/70 bg-white/70 px-4 py-2 text-sm font-bold text-orange-500 shadow-lg md:block">
              ⭐ Family Friendly
            </div>
        ...
        <section id="products" className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-[#21451f] sm:text-4xl">
                A playful storefront that feels warm, premium, and easy to love
              </h2>
              <p className="mt-4 text-base leading-7 text-stone-600">
                This version keeps the colorful storybook-style look, but removes all extra animation dependencies so the page can load more reliably.
              </p>
            </div>
            <a
              href="#contact"
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {products.map((product) => (
              ...
              >
                <div className="relative p-4" style={{ background: product.glow }}>
                  <div className="absolute right-4 top-4 rounded-full bg-white/80 px-3 py-2 text-lg shadow-md">
                    {product.emoji}
                  </div>
              ...
              {bundles.map((bundle) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="rounded-full bg-white/15 px-3 py-2 text-lg">
                      {bundle.emoji}
                    </div>
                  </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {dailyUse.map((item) => (
                ...
                >
                  <div className="mb-3 inline-flex rounded-full bg-orange-50 px-3 py-2 text-sm">
                    🛍️
                  </div>
          ...
          <div className="overflow-hidden rounded-[2.5rem] border border-white/70 bg-[linear-gradient(135deg,#fff7eb_0%,#ffeccf_100%)] p-8 shadow-[0_20px_70px_rgba(197,138,47,0.18)] lg:p-10">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-black tracking-tight text-[#21451f] sm:text-4xl">
                  Message us directly and turn this page into a real sales channel.
                </h2>
                <p className="mt-4 max-w-2xl text-base leading-7 text-stone-600">
                  The design is now cheerful, premium, and eye-catching while staying lightweight and easier to run.
                </p>
              </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-stone-600">
                A cheerful, modern storefront for science-led everyday nourishment.
              </p>
            </div>
          </div>
