...
export default function App() {
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: 30, background: "#f8f5ef", minHeight: "100vh" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        <img src="/logo.png" width="80" alt="Gut Lab by Xaels logo" />
      ...
      <div style={{ marginTop: 40, textAlign: "center" }}>
        <a href="https://vt.tiktok.com/ZSH2SPbE4/" target="_blank" rel="noreferrer">
          <button
            style={{
              padding: "15px 30px",
              fontSize: 18,
